...
const MedicalCenterCard = ({ imageSrc, name, location, rating, reviews }) => {
  ...
  return (
    <div className="rounded overflow-hidden shadow-lg flex flex-col relative">
      ...
      <a href="#!" id="favoriteButton" onClick={handleFavoriteClick}>
        ...
        >
          <img
            src={isFavorite ? FilledFavoriteIcon : FavoriteIcon} // Use different icon for filled state
            alt="Favorite Icon"
      ...
      <div className="px-6 py-4 mb-auto">
        ...
        <div className="flex items-center">
          ...
          {[...Array(5)].map((_, index) => (
            <img
              key={index}
              src={index < Math.floor(rating) ? RatingIcon : EmptyStarIcon}
              alt="Rating Icon"
