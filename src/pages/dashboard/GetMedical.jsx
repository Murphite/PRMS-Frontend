    ...
    return (
        <div className="flex">
            ...
            <div className="w-full max-w-screen-lg mt-24 mx-5">
                ...
                <div className="overflow-x-auto mt-5 w-[72rem]">
                    <table className="table border-collapse border border-gray-200">
                        <thead>
                            <tr>
                                ...
                                <th className=" px-28 py-2 border border-gray-200">Instructions</th>
                                <th className="px-4 py-2 border border-gray-200">Duration</th>
                                <th className="px-4 py-2 border border-gray-200">Frequency</th>
                        ...
                        <tbody>
                            ...
                            medicalHistory.map((category, index) => (
                                <tr key={index}>
                                    <td className="px-8 py-2 border border-gray-200">{category.date}</td> 
                                    <td className="px-4 py-2 border border-gray-200">{category.physicianName}</td>
                                    <td className="px-4 py-2 border border-gray-200">{category.medicationName}</td>
                                    <td className="px-4 py-2 border border-gray-200">{category.dosage}</td>
                                    <td className="px-4 py-2 border border-gray-200">{category.instruction}</td>
                                    <td className="px-4 py-2 border border-gray-200">{category.duration}</td>
                                    <td className="px-4 py-2 border border-gray-200">{category.frequency}</td>
                                    <td className="px-4 py-2 border border-gray-200">{category.status}</td>
                                    <td className="px-8 py-2 border border-gray-200 font-bold text-green-500 cursor-pointer " onClick={handleClick}> View</td>
                                </tr>
                            ))}
